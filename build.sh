...
iso_name=SmootArchOS
iso_label="SmootArchOS_$(date +%Y%m)"
iso_publisher="Francesco <http://www.github.com/FrancescoXD>"
iso_application="A linux distribution based on ArchLinux"
